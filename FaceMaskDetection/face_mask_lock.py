...
# p = GPIO.PWM(2, 50)
# p.start(8.8)
# E:\NagpurAadhyaa/FaceMaskDetection/face_mask_lock.py


def mask_detection():
    face_cascade = cv2.CascadeClassifier(
        'FaceMaskDetection/haarcascade_frontalface_default.xml')

    mouth_cascade = cv2.CascadeClassifier(cv2.data.haarcascades + "haarcascade_msc_mouth.xml")
